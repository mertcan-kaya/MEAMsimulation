function plotAxes(UIAxes,anm,rbt,out)

    if anm.high_quality == 1
        time_factor = 10;    
    else
        time_factor = 5;    
    end
    ...
    if anm.robot_1_on == 1 || anm.robot_2_on == 1
        if anm.base_on == 1, temp = load('base_block.mat');  ms.sB = temp.modelstruct; end
        if rbt.ee_att_1 > 0 || rbt.ee_att_2 > 0, temp = load('ati_delta.mat');  ms.sS = temp.modelstruct; end
        if rbt.ee_att_1 == 2 || rbt.ee_att_1 == 5 || rbt.ee_att_2 == 2 || rbt.ee_att_2 == 5
            temp = load('gripper.mat');  ms.sG = temp.modelstruct;
        end
        if rbt.ee_att_1 == 3 || rbt.ee_att_2 == 3
            temp = load('adaptor_holder_new2.mat');  ms.sTa = temp.modelstruct;
            temp = load('rod_sphere_new2.mat');  ms.sTb = temp.modelstruct;
        end
        if rbt.ee_att_1 == 4 || rbt.ee_att_1 == 5 || rbt.ee_att_2 == 4 || rbt.ee_att_2 == 5
    ...
    if anm.robot_1_on == 1
        Pobj_1 = modelProperties(UIAxes,ms,ms_1,anm.base_on,rbt.ee_att_1);
        
        [a_i_1,alpha_i_1,d_i_1,thetaPlus_i_1] = kinematicParametersOrigin(rbt.robot_model_1);

        if rbt.robot_model_1 == 2
            sensor_angle_1 = pi/4;
        else
            sensor_angle_1 = 0;
        end
    ...
    if anm.robot_2_on == 1
        Pobj_2 = modelProperties(UIAxes,ms,ms_2,anm.base_on,rbt.ee_att_2);
        
        [a_i_2,alpha_i_2,d_i_2,thetaPlus_i_2] = kinematicParametersOrigin(rbt.robot_model_2);

        if rbt.robot_model_2 == 2
            sensor_angle_2 = pi/4;
        else
            sensor_angle_2 = 0;
        end
    ...
    if anm.base_on == 1, minZ = -0.6; else, minZ = 0.0; end
        ...
        for j = 1:m
            for t = 1:time_factor:length(time)
                ...
                if j > n+1
                    ...
                    if j > n+2
                        if rbt.ee_att_1 == 2 || rbt.ee_att_1 == 5
                            TFbkI_h_1(:,:,n+3) = TFbkI_h_1(:,:,n+2)*trnZ(gripper_length);
                        elseif rbt.ee_att_1 == 3
        ...
        for j = 1:m
            for t = 1:time_factor:length(time)
                ...
                if j > n+1
                    ...
                    if j > n+2
                        if rbt.ee_att_2 == 2 || rbt.ee_att_2 == 5
                            TDesI_h_2(:,:,n+3) = TDesI_h_2(:,:,n+2)*trnZ(gripper_length);
                        elseif rbt.ee_att_2 == 3
    ...
    for t = 1:time_factor:length(time)
        ...
        if anm.robot_1_on == 1
            ...
            if length(time) > 1
                ...
                plot3(UIAxes,PDesI_e_1(1,1:time_factor:end),PDesI_e_1(2,1:time_factor:end),PDesI_e_1(3,1:time_factor:end),':b')
                plot3(UIAxes,PFbkI_e_1(1,1:time_factor:t),PFbkI_e_1(2,1:time_factor:t),PFbkI_e_1(3,1:time_factor:t),'m')
            end
            
            if anm.base_on == 1, nvB = [ms.sB.V,ones(size(ms.sB.V(:,1)))]*TFbkI_h_1(:,:,1)'; end
            ...
            if rbt.ee_att_1 > 0, nvS = [ms.sS.V,ones(size(ms.sS.V(:,1)))]*rotZ(sensor_angle_1)'*TFbkI_h_1(:,:,8)'; end
            if rbt.ee_att_1 == 2 || rbt.ee_att_1 == 5
            ...
            if anm.base_on == 1, set(Pobj_1.pB,'Vertices',nvB(:,1:3)), end
            ...
            if rbt.ee_att_1 > 0, set(Pobj_1.pS,'Vertices',nvS(:,1:3)), end
            if rbt.ee_att_1 == 2 || rbt.ee_att_1 == 5
            ...
            if rbt.ee_att_1 == 4 || rbt.ee_att_1 == 5
        ...
        if anm.robot_2_on == 1
            ...
            if anm.base_on == 1, nvB = [ms.sB.V,ones(size(ms.sB.V(:,1)))]*TDesI_h_2(:,:,1)'; end
            ...
            if rbt.ee_att_2 > 0, nvS = [ms.sS.V,ones(size(ms.sS.V(:,1)))]*rotZ(sensor_angle_2)'*TDesI_h_2(:,:,8)'; end
            if rbt.ee_att_2 == 2 || rbt.ee_att_2 == 5
            ...
            if anm.base_on == 1, set(Pobj_2.pB,'Vertices',nvB(:,1:3)), end
            ...
            if rbt.ee_att_2 > 0, set(Pobj_2.pS,'Vertices',nvS(:,1:3)), end
            if rbt.ee_att_2 == 2 || rbt.ee_att_2 == 5
            ...
            if rbt.ee_att_2 == 4 || rbt.ee_att_2 == 5, set(Pobj_2.pO,'Vertices',nvO(:,1:3)), end
        end

        hold(UIAxes,'off')

        set(UIAxes,	'Projection','perspective', ...
        ...
        title(UIAxes,['Time: ',num2str(real_time),' s'])
%         drawnow;
        drawnow limitrate
    
        real_time = real_time + time_factor*0.004;
    end
